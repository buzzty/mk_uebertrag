...
public class GameLogic : MonoBehaviour
{
    ...
    IEnumerator QuizTwoAnswerWrong()
    {
        ...
        {
            quizTwoWrong.text = "Try a bit higher!";
        ...
        {
            quizTwoWrong.text = "Try a bit lower!";
            quizTwoWrong.gameObject.SetActive(true);
            yield return new WaitForSeconds(1.5f);
        }
        ...
        {
            quizTwoWrong.text = "Try a lot lower!";
            quizTwoWrong.gameObject.SetActive(true);
            yield return new WaitForSeconds(1.5f);
        }
    }
    ...
    IEnumerator QuizFourAnswerWrong()
    {
        ...
        {
            quizFourWrong.text = "Try a bit lower!";
        ...
        {
            quizFourWrong.text = "Try a bit higher!";
            quizFourWrong.gameObject.SetActive(true);
            yield return new WaitForSeconds(1.5f);
        }
        ...
        {
            quizFourWrong.text = "Try a lot higher!";
            quizFourWrong.gameObject.SetActive(true);
            yield return new WaitForSeconds(1.5f);
        }
    }
